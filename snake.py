...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("jackmitc/rotaryencoder", 2)
    client.subscribe("jackmitc/lightsensor", 2)
    client.subscribe("jackmitc/soundsensor", 2)
    client.subscribe("jackmitc/temphum", 2)
